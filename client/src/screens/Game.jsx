...
const STATUS_INFO = {
  ...
  apprivoise: { icon: "🔥", label: "ฉันคว้ามันได้แล้ว", cls: "bg-echo-hp", desc: "ร่างทาวเบิร์น: ปลดล็อกสกิลพื้นฐาน 2/สกิลรอง/ท่าไม้ตาย พลังโจมตีถาวร +1 — คงอยู่ 10 เทิร์น หมดแล้วกลับเป็นทาคุโตะปกติ ต้องเก็บดวงดาวให้ครบ 5 อีกครั้งเพื่อแปลงร่างใหม่" },
