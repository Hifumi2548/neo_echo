...
const STATUS_INFO = {
  ...
  rsHopper:  { icon: "🦘", label: "RS-HOPPER", cls: "bg-echo-armor", desc: "RS-HOPPER: กันความเสียหายที่ไม่ได้มาจากปุ่มโจมตีปกติได้เต็มทันที (ไม่ว่าเลือดเหลือเท่าไหร่) — ปุ่มโจมตีปกติกันเต็มไม่ได้ แต่กันไม่ให้เลือดต่ำกว่า 4 (เฉพาะตอนเลือด >4) ใช้ชาร์จร่วมกัน ฟื้น 1 ชาร์จทุก 3 เทิร์น สูงสุด 3" },
  ...
  yaak:        { icon: "🥊", label: "ย๊ากก!", cls: "bg-echo-gold text-gray-900", desc: "ย๊ากก!: การโจมตีปกติครั้งถัดไป +1 หน่วย — ใช้ครั้งเดียวแล้วหมด คงอยู่จนกว่าจะได้โจมตี" },
