...
//  หมายเหตุ: "หลับไหล" (sleep status) และการเช็คว่าผู้ชนะหลับอยู่ไหมตอนจะโจมตี เป็นกลไก generic
//  ที่ core engine ใช้ตรวจสอบทุกตัวละคร (ไม่ใช่แค่โอเบรอน) จึงยังอยู่ server.js — เช่นเดียวกับ
//  oberonZero/oberonDayAtk (ส่วนร่วมในสูตรดาเมจรวม doAttack ~800 บรรทัด shared pipeline)
// ============================================================
